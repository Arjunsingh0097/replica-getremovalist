  ...
  return (
    <section className="py-12 sm:py-16 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-900 mb-6 sm:mb-8 leading-tight">
        ...
        <div className="flex justify-center">
          <a 
            href="/job/new" 
            className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-amber-500 hover:bg-amber-600 text-blue-900 font-semibold rounded-full shadow-md transition-all duration-300 hover:-translate-y-1 text-sm sm:text-base"
          >
            Get Moving Quotes
