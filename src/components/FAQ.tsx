        ...
        <div className="space-y-0">
          {faqs.map((faq, index) => (
            <div key={index}>
              ...
              >
                <span className="text-black font-['DM_Sans'] text-base sm:text-lg font-medium pr-3 sm:pr-4">
                  {faq.question}
                </span>
                <ChevronDown 
                  className={`w-4 h-4 sm:w-5 sm:h-5 text-[#E53E3E] transition-transform duration-200 ${
