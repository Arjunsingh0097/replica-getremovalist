        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-black mb-3 sm:mb-4">Home removals</h3>
            ...
            {/* Furniture removals */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-black mb-3 sm:mb-4">Furniture removals</h3>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
            ...
            {/* Mini moves */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-black mb-3 sm:mb-4">Mini moves</h3>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
            ...
            {/* Interstate removals */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-black mb-3 sm:mb-4">Interstate removals</h3>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
            ...
            {/* Removalists near me */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl sm:text-2xl font-bold text-black mb-3 sm:mb-4">Removalists near me</h3>
