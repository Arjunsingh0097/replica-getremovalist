...
export default function CustomerTestimonials() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-[#1C2235] to-[#121826]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white/10 border border-white/10 rounded-2xl p-8 shadow-lg backdrop-blur-md transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl"
            >
              {/* Quote Icon */}
