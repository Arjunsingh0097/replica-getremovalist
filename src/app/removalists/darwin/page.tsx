...
import DarwinContent from "@/components/DarwinContent";
...
export default function DarwinRemovalists() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <Hero 
        heading="Find Darwin Removalists" 
        subheading="Professional removalists in Darwin for your local move. Compare quotes from trusted Darwin movers and get the best rates."
      />
      <PricingSection city="Darwin" />
      <DarwinContent />
      <Stats />
      <RecentlyBookedMoves />
