...
import HobartContent from "@/components/HobartContent";
...
export default function HobartRemovalists() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <Hero 
        heading="Find Hobart Removalists" 
        subheading="Professional removalists in Hobart for your local move. Compare quotes from trusted Hobart movers and get the best rates."
      />
      <PricingSection city="Hobart" />
      <HobartContent />
      <Stats />
      <RecentlyBookedMoves />
