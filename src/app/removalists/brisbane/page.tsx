...
import BrisbaneContent from "@/components/BrisbaneContent";
...
export default function BrisbaneRemovalists() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <Hero 
        heading="Find Brisbane Removalists" 
        subheading="Professional removalists in Brisbane for your local move. Compare quotes from trusted Brisbane movers and get the best rates."
      />
        <PricingSection city="Brisbane" />
        <BrisbaneContent />
      <Stats />
      <RecentlyBookedMoves />
