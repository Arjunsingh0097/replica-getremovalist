...
import PerthContent from "@/components/PerthContent";
...
export default function PerthRemovalists() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <Hero 
        heading="Find Perth Removalists" 
        subheading="Professional removalists in Perth for your local move. Compare quotes from trusted Perth movers and get the best rates."
      />
