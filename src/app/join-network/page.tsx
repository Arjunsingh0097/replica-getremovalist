      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-black font-['DM_Sans'] mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black font-['DM_Sans']">Get job leads</h3>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black font-['DM_Sans']">Showcase your business</h3>
                </div>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black font-['DM_Sans']">Track and manage quotes and bookings</h3>
                </div>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black font-['DM_Sans']">Competitive pricing with no commissions</h3>
                </div>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 md:col-span-2">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black font-['DM_Sans']">Follow up quotes directly with the customer</h3>
                </div>
                <p className="text-gray-600">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-3xl font-bold text-black font-['DM_Sans'] mb-8">Register Your Business</h2>
