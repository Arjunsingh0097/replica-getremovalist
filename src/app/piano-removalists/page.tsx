...
// Australia-wide piano removalists component
function AustraliaWidePianoRemovalists() {
  const cities = [
    // Column 1
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-blue-900 mb-4">
            Find Piano Removalists Australia Wide
          </h2>
          <p className="text-lg text-gray-600">
            Professional piano removalists serving all major cities across Australia
          </p>
        </div>
...
export default function PianoRemovalists() {
  return (
    <div className="min-h-screen bg-white">
      <Navbar />
      <Hero 
        heading="Find Piano Removalists" 
        subheading="Specialist piano removalists for safe and secure piano transport. Compare quotes from experienced piano movers."
      />
      <Stats />
      <RecentlyBookedMoves />
